...
function App() {
    ...
    <>
        ...
        <div className="Headings">
            <h1 className="font-bold text-3xl leading-loose">The new vyond streaming website</h1>
            <h2 className="font-bold text-2xl leading-loose">Made by your favorite creators!</h2>
            <tr className="Imagesprofile">
                <td><img className="Profileimage1" src={profile1} alt="areg"/>
                    <div className="textprofile1 font-bold text-2xl"><h2>Areg</h2></div>
                </td>
                <td><img className="Profileimage2" src={profile2} alt="leon"/>
                    <div className="textprofile1 font-bold text-2xl"><h2>1Leon</h2></div>
                </td>
                <td><img className="Profileimage3" src={profile3} alt="veyshal"/>
                    <div className="textprofile1 font-bold text-2xl"><h2>Veyshal</h2></div>
                </td>
            </tr>
        </div>
        </body>
