                ...
                <div className="Headings">
                    ...
                    >
                        <CarouselContent>
                            ...
                            <CarouselItem className="md:basis-full lg:basis-1/3"><Link to="/Unhappy-25-Years-Little-Brat"><img src="https://utfs.io/f/thKihuQxhYcPLxIb067sUfwWMR5jlKuYe27zh6kLtx3rGyTm" alt="unhappybrat"/></Link></CarouselItem>
