        ...
        <div className="flex-1 flex items-center justify-center py-8">
          <div className="container text-center">
            ...
            <p className="text-2xl leading-loose">
              ...
              provider, Postal code(in some countries), User Agent, IP address
              and request codes will be stored on a logging service for 3 days
              before deleted.
            </p>
            <p className="text-2xl leading-loose">
            ...
            <p className="text-2xl leading-loose">
              By visiting anything on Ocean+ your data will be recorded by
              Datadog for website load speed measurement.
            </p>
          </div>
        </div>
        <Footer />
